...
An AgileX Piper arm camera mount / Piper arm camera mount / Piper wrist camera mount that takes the Intel RealSense D435, D435i, and D405 interchangeably. It is a modified version of kai0's "end-effector-camera-mount-d435i-centered.STEP" work.
...
- Files ending in `_part`: the model split into separate parts for 3D printing (STL)
- `.step` file: the full drawing — the complete source geometry for editing/modification
